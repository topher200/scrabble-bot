...
board = Board()
def add_to_board(word, starting_position, direction):
...
add_to_board('asdf', Position(7, 5), ACROSS)
print(get_word(Position(7,7), ACROSS))
